								...
								if	(mysql_num_rows($new)	>	0)	{
												while	($news	=	mysql_fetch_array($new))	{
																...
																<div id="carousel" class="carousel slides " style="box-shadow: 0px 3px 11px rgba(0, 0, 0, 0.7);">
																				...
																				<div class="carousel-inner">
																								<div class="item active">
																												...
																												if	(trim($news['url_pict'])	!=	""	&&	trim($news['url_pict'])	!=	"-")	{
																																$a	=	1;
																																echo	"<img  class=imgnewssliders src="	.	$news['url_pict']	.	">";
																																echo	"<div class=carousel-caption>";
																																echo	"<p class='namenewsslifers' >"	.	$news['name']	.	"</p>";
																																echo	"</div>";
																												}	else	{
																								...
																								<div class="item">
																												...
																												if	(trim($news['url_pict_1'])	!=	""	&&	trim($news['url_pict_1'])	!=	"-")	{
																																$a	=	1;
																																echo	"<img  class=imgnewssliders src="	.	$news['url_pict_1']	.	">";
																																echo	"<div class=carousel-caption>";
																																echo	"<p class='namenewsslifers' >"	.	$news['name']	.	"</p>";
																																echo	"</div>";
																												}	else	{
																								...
																								<div class="item">
																												...
																												if	(trim($news['url_pict_2'])	!=	""	&&	trim($news['url_pict_2'])	!=	"-")	{
																																...
																																if	(isset($a))	{
																																				$c	=	1;
																																				echo	"<img  class=imgnewssliders src="	.	$news['url_pict_2']	.	">";
																																				echo	"<div class=carousel-caption>";
																																				echo	"<p class='namenewsslifers' >"	.	$news['name']	.	"</p>";
																																				echo	"</div>";
																																}
																								...
																								<div class="item">
																												...
																												if	(trim($news['url_pict_3'])	!=	""	&&	trim($news['url_pict_3'])	!=	"-")	{
																																...
																																if	(isset($a))	{
																																				$d	=	1;
																																				echo	"<img  class=imgnewssliders src="	.	$news['url_pict_3']	.	">";
																																				echo	"<div class=carousel-caption>";
																																				echo	"<p class='namenewsslifers' >"	.	$news['name']	.	"</p>";
																																				echo	"</div>";
																																}
																								...
																								<div class="item">
																												...
																												if	(trim($news['url_pict_4'])	!=	""	&&	trim($news['url_pict_4'])	!=	"-")	{
																																...
																																if	(isset($a))	{
																																				$e	=	1;
																																				echo	"<img  class=imgnewssliders src="	.	$news['url_pict_4']	.	">";
																																				echo	"<div class=carousel-caption>";
																																				echo	"<p class='namenewsslifers' >"	.	$news['name']	.	"</p>";
																																				echo	"</div>";
																																}
																				...
																				if	(isset($a))	{
																								echo	'<a href="#carousel" class="left carousel-control" data-slide="prev">';
																								echo	'<span class="glyphicon glyphicon-chevron-left" > </span>';
																								echo	'</a>';
																								echo	'<a href="#carousel" class="right carousel-control" data-slide="next">';
